...
def simulate_malfunctioning(simulation_times=100, pop_n=100, max_iteration=10000, k=3, init_x = 0.5, mal_x = 0.5, equal_weights=False,
            ...
            if pooling:
                ...
                if weights_updating == "beta":
                    ...
                    if not equal_weights:
                        opinion_pooling(pool, threshold=threshold, memory=memory, lamb=memory_weight)
                    else:
...
def simulate_malicious_acc_bc(simulation_times=100, pop_n=100, max_iteration=10000, k=3, init_x = 0.5, classification = True, dampening=None,
                       alpha=0.5, prob_evidence=0.02, malicious=0.01, mal_c=None, strategy='deception', threshold= 0.5, weights_updating = None,
                       noise=None, pooling=True, memory=False, memory_weight=0.5, consensus_only=False, detection_only=False):
        ...
        for i in range(max_iteration):
            ...
            if pooling:
                ...
                if weights_updating == "beta":
                    ...
                    opinion_pooling_malicious_bc(pool, threshold=threshold, strategy=strategy,memory=memory, lamb=memory_weight)
