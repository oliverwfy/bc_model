...
directory_name = 'min_rule/consensus_heatmap/'
...
consensus_ru_mat = np.zeros((len(pool_size_ls), len(malicious_ls)))
...
np.save(directory_name + f'consensus_ru_heatmap_malicious_k.npy', consensus_ru_mat)
# np.save(directory_name + f'consensus_eq_heatmap_malicious_k.npy', consensus_eq_mat
# np.save(directory_name + f'consensus_bc_heatmap_malicious_k.npy', consensus_bc_mat)


plt.figure()

sns.heatmap(pd.DataFrame(consensus_ru_mat, index=np.flip(pool_size_ls), columns=malicious_ls), vmin=0, vmax=max_iteration)
...
plt.savefig(directory_name + f'consensus_time_heatmap_ru_malicious_k.png')


#
# plt.figure()
#
# sns.heatmap(pd.DataFrame(consensus_eq_mat, index=np.flip(pool_size_ls), columns=malicious_ls), vmin=0, vmax=max_iteration)
#
# # plt.xlabel(r'$\beta$', fontsize=14)
# # plt.ylabel('k', fontsize=14)
# # plt.title(rf'$\gamma = {threshold},\alpha = {alpha}, \epsilon={noise}$', fontsize=14)
...
#
#
# plt.savefig(directory_name + f'consensus_time_heatmap_eq_malicious_k.png')
#
# plt.figure()
#
# sns.heatmap(pd.DataFrame(consensus_bc_mat, index=np.flip(pool_size_ls), columns=malicious_ls), vmin=0, vmax=max_iteration)
#
# # plt.xlabel(r'$\beta$', fontsize=14)
# # plt.ylabel('k', fontsize=14)
# # plt.title(rf'$\gamma = {threshold},\alpha = {alpha}, \epsilon={noise}$', fontsize=14)
...
#
#
# plt.savefig(directory_name + f'consensus_time_heatmap_bc_malicious_k.png')
#
