...
directory_name = 'min_rule/consensus/'
...
noise_ls = np.linspace(0, 0.03, 31)
...
plt.plot(evidence_rate_ls, consensus_bc)
...
plt.legend(['equal weights', 'bc', 'reliability updating'], fontsize=14)


plt.savefig(directory_name + f'consensus_time_noise_0.3.png')
