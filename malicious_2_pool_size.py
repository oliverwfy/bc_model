...
plt.figure('avg belief (pool size)')
...
plt.savefig(file_name + 'malicious_2_pool_size_avg_belief.png')


plt.figure('consensus (pool size)')

plt.plot(pool_ls, consensus_evidence, '--')
plt.plot(pool_ls, consensus_own)
plt.plot(pool_ls, consensus_pooled)
plt.plot(pool_ls, consensus_confidence)
plt.ylim(0, max_iteration)
plt.legend(['evidence only', 'own belief', 'pooled belief', 'confidence updating'])
plt.title('consensus time in different models')
plt.xlabel('pool size k')
plt.ylabel('iteration')
plt.savefig(file_name + 'malicious_2_pool_size_consensus.png')
